...
7. После обновления откройте сайт с принудительной перезагрузкой. Service Worker использует версию кэша `neivum-0.1-maximum-v5` и автоматически удалит предыдущую оболочку.
